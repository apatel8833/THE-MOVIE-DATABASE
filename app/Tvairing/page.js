...
const page = () => {
    ...
    const Movies = useSelector((state) => state.tvairing.tvairing)
    console.log("tvairing", Movies);
    const[load,setLoad] = useState(1)


    useEffect(() => {
        dispatch(TvairingData(load)); 
            ...
            <div className='w-full h-100 p-4'>
                <div>
                    <div className='flex content-between items-end w-96'>
                        <h1 className='fs-3 fw-medium'>Airing Today..</h1>
                    </div>
